...
export function WeatherSection({ data, lastRefresh, coordinates }: WeatherSectionProps & { coordinates?: { lat: number; lng: number } | null }) {
  return (
    <section className="mb-6 md:mb-8 space-y-6" aria-labelledby="weather-heading">
