  ...
  public: {
    Tables: {
      ...
      outfit_feedbacks: {
        ...
        Relationships: [
          {
            foreignKeyName: "outfit_feedbacks_location_id_fkey";
            columns: ["location_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "outfit_feedbacks_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      service_reminders: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_reminders_bike_id_fkey";
            columns: ["bike_id"];
            isOneToOne: false;
            referencedRelation: "bikes";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "service_reminders_completed_service_id_fkey";
      ...
      shared_outfits: {
        ...
        Relationships: [
          {
            foreignKeyName: "shared_outfits_feedback_id_fkey";
            columns: ["feedback_id"];
            isOneToOne: true;
            referencedRelation: "outfit_feedbacks";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "shared_outfits_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
