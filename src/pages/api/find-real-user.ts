...
export const GET: APIRoute = async ({ locals }) => {
  try {
    ...
    return new Response(JSON.stringify({
      success: false,
      realUserFound: false,
      message: 'Brak prawdziwych użytkowników. Musisz utworzyć mock profil przez Supabase Dashboard.',
      instruction: 'Wykonaj SQL w Supabase Dashboard: INSERT INTO profiles...'
    }), { 
      status: 200,
      headers: { 'Content-Type': 'application/json' }
    });
