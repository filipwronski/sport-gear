...
export class SimpleLocationService {
  ...
  async createLocation(
    ...
    if (command.is_default) {
      ...
      if (updateError) {
        console.error(
          "[SimpleLocationService] Error updating default locations:",
          updateError,
        );
        throw new Error(
  ...
  async deleteLocation(userId: string, locationId: string): Promise<void> {
    ...
    if (fetchError) {
      console.error(
        "[SimpleLocationService] Error fetching user locations:",
        fetchError,
      );
    ...
    if (deleteError) {
      console.error(
        "[SimpleLocationService] Error deleting location:",
        deleteError,
      );
  ...
  async getNearbyLocations(
    ...
    if (error) {
      console.error(
        "[SimpleLocationService] Error fetching nearby locations:",
        error,
      );
      return [];
    }
